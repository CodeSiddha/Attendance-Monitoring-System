...
<!-- /Sidebar -->
        <div id="hk_nav_backdrop" class="hk-nav-backdrop" style="font-family: 'Josefin Sans'"></div>
        <!-- /Vertical Nav -->
        <!-- Main Content -->
        <div class="hk-pg-wrapper" style="font-family: 'Josefin Sans';background-color:white">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h1 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Add a Class</h1>
                </div>
                <!-- /Title -->
...
<input class="form-control" type="text" name="classname" placeholder="Class Name" required="true" autofocus style="background-color:#282B34;color:white">
</div>
</div>  
