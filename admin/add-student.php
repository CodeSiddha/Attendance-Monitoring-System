...
$sql="INSERT INTO  tblstudents(parentId,studentName,studentAdress,studentContact,studentDob,studentJoinDate,studentRollNumber,studentClass,
studentUsername,studentPassword) 
VALUES(:parentid,:stdname,:stdaddress,:stdcontact,:stddob,:jdate,:rollno,:clname,:susername,:spass)";
...
<!-- /Sidebar -->
        ...
        <!-- /Vertical Nav -->
        <!-- Main Content -->
        <div class="hk-pg-wrapper"style="font-family: 'Josefin Sans';background-color:white">
            <!-- Breadcrumb -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h1 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Add a Student</h1>
                </div>
                <!-- /Title -->
                    ...
                    <div class="col-xl-12">
                     <form name="addstudent" method="post">  
                        <section class="hk-sec-wrapper" style="background-color:#282B34;color:#04AB6C">
                            <h5 class="hk-sec-title"style="color:#04AB6C">Fill the info</h5>
...
<select class="form-control" name="parent" required="required" style="background-color:#282B34; color:white" >
...
<div class="col-md-6 mt-10">
<input class="form-control" type="text" name="stdname" placeholder="Student Name" required="true" autofocus style="background-color:#282B34;color:white">
</div>
</div>  
...
<textarea name="stdaddress"  class="form-control"  required="true" placeholder="Enter parent address" autofocus style="background-color:#282B34;color:white"></textarea> 
</div>
</div>
...
<div class="col-md-6 mt-10">
<input class="form-control" type="text" name="stdcontact" placeholder="Student Contact" pattern="[0-9]{10}" title="10 numeric characters only" maxlength="10" required="true" autofocus style="background-color:#282B34;color:white">
</div>
</div>  
...
<div class="col-md-6 mt-10">
<input type="text" name="dob" required="true" autofocus data-mask="9999-99-99" class="form-control"style="background-color:#282B34;color:white">
<span class="form-text text-muted"style="color:#04AB6C">yyyy-mm-dd</span>
</div>
</div>  
...
<div class="col-md-6 mt-10">
<input type="text" name="joindate" required="true" autofocus data-mask="9999-99-99" class="form-control"style="background-color:#282B34;color:white">
<span class="form-text text-muted"style="color:#04AB6C">yyyy-mm-dd</span>
</div>
</div>
...
<div class="col-md-6 mt-10">
<select class="form-control stdcls" name="classname" required="required"style="background-color:#282B34; color:white">
<option value=""> Select </option>
<?php 
...
<div class="row">
<div class="col-md-2 mt-15">Roll Number : </div>
<div class="col-md-6 mt-10">
<input class="form-control rollno" type="text" onBlur="checkRollnoAvailability()" name="rollno" placeholder="Roll Number" required="true" autofocus style="background-color:#282B34; color:white"> 
...
<div class="col-md-6 mt-10">
<input class="form-control" type="text" name="stdusername" id="stdusername" placeholder="username" pattern="^[a-zA-Z][a-zA-Z0-9-_.]{4,8}$" title="must be alphanumeric 5 to 8 chars" required="true" onBlur="checkAvailability()" autofocus style="background-color:#282B34; color:white">
...
<div class="col-md-6 mt-10">
<input class="form-control" type="password" name="ppassword" placeholder="Password" required="true" autofocus style="background-color:#282B34; color:white">
</div>
</div>
...
<div class="col-md-6 mt-10">
<button type="submit" class="btn btn-primary" id="submit" name="submit" style="background-color:#04AB6C">Submit</button>
</div>
