        ...
        <div class="hk-pg-wrapper" style="background-color:white">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Edit a Staff</h4>
                </div>
                <!-- /Title -->
...
<div class="col-md-6 mt-10">
<input class="form-control" type="text" name="staffusername" id="staffusername" value="<?php echo htmlentities($result->staffUsername);?>" readonly="true">
