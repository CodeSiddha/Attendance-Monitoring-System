        ...
        <div class="hk-pg-wrapper" style="font-family: 'Josefin Sans';background-color:white">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h1 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Add a Staff</h1>
                </div>
                <!-- /Title -->
...
<input class="form-control" type="text" name="staffname" placeholder="Staff Name" required="true" autofocus style="background-color:#282B34;color:white">
</div>
</div>  
...
<div class="col-md-6 mt-10">
<input class="form-control" type="text" name="staffcontact" placeholder="Staff Contact" pattern="[0-9]{10}" title="10 numeric characters only" maxlength="10" required="true" autofocus style="background-color:#282B34;color:white">
</div>
</div>  
...
<div class="col-md-6 mt-10">
<input class="form-control" type="text" name="staffusername" id="staffusername" placeholder="username" pattern="^[a-zA-Z][a-zA-Z0-9-_.]{4,8}$" title="must be alphanumeric 5 to 8 chars" required="true" onBlur="checkAvailability()" autofocus style="background-color:#282B34;color:white">
...
<div class="col-md-6 mt-10">
<input class="form-control" type="password" name="staffpassword" placeholder="Password" required="true" autofocus style="background-color:#282B34;color:white">
</div>
</div>
