        ...
        <div class="hk-pg-wrapper" style="background-color:white">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Edit a Student</h4>
                </div>
                <!-- /Title -->
...
foreach($rt as $rw)
{               ?>  
<option value="<?php echo htmlentities($rw->id);?>"><?php echo htmlentities($rw->parentName);?></option>
 <?php }} ?> 
</select>
</div>
</div>
...
<div class="col-md-6 mt-10">
<input class="form-control" type="text" value="<?php echo htmlentities($result->studentUsername);?>"  name="stdusername" id="stdusername" placeholder="username"  readonly="true" >
