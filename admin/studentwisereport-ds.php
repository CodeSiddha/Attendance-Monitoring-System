...
<select class="form-control" name="className" id="className" onChange="getStudent(this.value);" required="required" style="background-color:#282B34;color:white">
...
<div class="col-md-6 mt-25">
<select class="form-control" name="studentname" id="studentname" o required="required" style="background-color:#282B34;color:white">
<option value=""> Select </option>
