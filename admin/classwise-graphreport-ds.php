...
<select class="form-control" name="className" required="required" style="background-color:#282B34;color:white">
...
<div class="col-md-6 mt-25">
<select class="form-control" name="attendstats" required="required" style="background-color:#282B34;color:white">
...
<input class="form-control" id="fdate" name="fdate" data-mask="9999-99-99" placeholder="yyyy-mm-dd" type="text" style="background-color:#282B34;color:white"/>   
</div>
</div>
...
<div class="col-md-6 mt-25">
<input class="form-control" id="tdate" name="tdate" data-mask="9999-99-99" placeholder="yyyy-mm-dd" type="text" style="background-color:#282B34;color:white"/>
</div>
</div>
