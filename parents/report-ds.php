...
$todate=$_POST['tdate'];
      ...
      $_SESSION['sname']=$stdname;
            echo "<script>window.location.href='report-details.php';</script>";
           }
        }
?>
<!DOCTYPE html>
...
<select class="form-control" name="studentname" id="studentname"  required="required">
<option value=""> Select </option>
<?php 
echo $pid=$_SESSION['prntid'];
$sql = "SELECT  id,studentName from  tblstudents where parentId=:pid order by studentName";
...
<?php echo htmlentities($result->studentName);?></option>
 <?php }} ?> 
</select>
</div>
</div>
