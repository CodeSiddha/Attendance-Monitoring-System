...
<h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span>Attendance Report of <?php echo htmlentities($studentname)?>  From <?php echo htmlentities($fdate);?> To <?php echo htmlentities($tdate);?></h4>
                </div>
                <!-- /Title -->
