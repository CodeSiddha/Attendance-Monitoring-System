...
$sql="SELECT  distinct attndDate,COUNT(IF((attndStatus=1 and attndShift=1) ,0, NULL))  as shft1present,COUNT(IF((attndStatus=2 and attndShift=1) ,0, NULL))  
as shft1late,COUNT(IF((attndStatus=0 and attndShift=1) ,0, NULL))  as shft1absent,COUNT(IF((attndStatus=1 and attndShift=2) ,0, NULL))  
as shft2present,COUNT(IF((attndStatus=0 and attndShift=2) ,0, NULL))  as shft2absent,COUNT(IF((attndStatus=2 and attndShift=2) ,0, NULL))  
as shft2late from tblattendance where studentClass=:clss and attndDate between :fdate and :tdate group by attndDate";
