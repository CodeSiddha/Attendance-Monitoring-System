...
$staffid=$_SESSION['stdid'];
  $sql ="SELECT id FROM tblstudents WHERE id=:staffid and studentPassword=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblstudents set studentPassword=:newpassword where id=:staffid";
