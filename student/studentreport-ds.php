...
$todate=$_POST['tdate'];
        ...
        $_SESSION['todate']=$todate;
            echo "<script>window.location.href='student-report.php';</script>";
           }
        }
?>
<!DOCTYPE html>
        ...
        <div class="hk-pg-wrapper" style="background-color:white">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Attendance  Report Date slection</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
...
<h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="toggle-right"></i></span></span> Attendance Report</h4>
                </div>
                <!-- /Title -->
...
<input class="form-control" id="fdate" name="fdate" placeholder="yyyy-mm-dd" type="text" style="background-color:#282B34;color:white"/>   
</div>
</div>
...
<div class="col-md-6 mt-25">
<input class="form-control" id="tdate" name="tdate" placeholder="yyyy-mm-dd" type="text" style="background-color:#282B34;color:white"/>
</div>
</div>
