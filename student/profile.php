                ...
                <div class="row">
                    <div class="col-xl-12">
                     <form name="editstudent" method="post">  
                        <section class="hk-sec-wrapper" style="background-color:#282B34; font-family: 'Josefin Sans', sans-serif; color:#04AB60">
...
<input class="form-control" type="text" value="<?php echo htmlentities($result->regDate);?>"  name="regdate" id="regdate"   readonly="true" style="background-color:#282B34;color:white">
...
<div class="col-md-6 mt-10">
<select class="form-control" name="parent" required="required" readonly style="background-color:#282B34;color:white">
...
<div class="col-md-6 mt-10">
<input class="form-control" type="text" name="stdname" value="<?php echo htmlentities($result->studentName);?>" placeholder="Student Name" required="true" autofocus style="background-color:#282B34;color:white">
</div>
</div>  
...
<div class="col-md-6  mt-15">
<textarea name="stdaddress"  class="form-control"  required="true" placeholder="Enter parent address" autofocus style="background-color:#282B34;color:white"><?php echo htmlentities($result->studentAdress);?></textarea> 
</div>
</div>
...
<div class="col-md-6 mt-10">
<input class="form-control" type="text" name="stdcontact" placeholder="Student Contact" pattern="[0-9]{10}" value="<?php echo htmlentities($result->studentContact);?>"  title="10 numeric characters only" maxlength="10" required="true" autofocus style="background-color:#282B34;color:white">
</div>
</div>  
...
<div class="col-md-6 mt-10"> 
<input type="text" name="dob" required="true" autofocus data-mask="9999-99-99" class="form-control" value="<?php echo htmlentities($result->studentDob);?>" style="background-color:#282B34;color:white">
...
<div class="col-md-6 mt-10">
<input type="text" name="joindate" required="true" autofocus data-mask="9999-99-99" class="form-control" value="<?php echo htmlentities($result->studentJoinDate);?>" style="background-color:#282B34;color:white" >
<span class="form-text text-muted">yyyy-mm-dd</span>
</div>
</div>
...
<div class="col-md-6 mt-10">
<input class="form-control rollno" type="text" onBlur="checkRollnoAvailability()" name="rollno" placeholder="Roll Number" required="true" value="<?php echo htmlentities($result->studentRollNumber);?>"  autofocus style="background-color:#282B34;color:white">
...
<div class="col-md-6 mt-10">
<input class="form-control" type="text" value="<?php echo htmlentities($result->studentUsername);?>"  name="stdusername" id="stdusername" title="Username can't be change" readonly="true" style="border:solid 1px red;readonly=true;background-color:#282B34;color:white" >
...
<div class="col-md-6 mt-10">
<button type="submit" class="btn btn-primary" id="submit" name="update" style="background-color:#04AB6C">Update</button>
</div>
